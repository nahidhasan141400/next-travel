    ...
    <div className="w-full  min-h-[700px] flex justify-center flex-col items-center">
      ...
      <div className="w-full flex-4 h-full grid grid-cols-1 md:grid-cols-2 max-w-[1200px]">
        ...
        <div className="w-full h-full relative md:ml-2">
          <p className="font-light text-justify mt-20 md:text-xl text-lg px-3 ">
            Sun Holidays Ltd. not only provides the best Umrah packages from
            Bangladesh, but also ensures that you complete your long-awaited
            travel to the two holy cities of Makkah and Madinah. Our most
            skilled and experienced Mu&#39;allim will accompany you the entire
            journey.
          </p>
          ...
          <a
            ...
            className="btn btn-outline btn-warning mt-20"
          >
